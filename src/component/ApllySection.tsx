  ...
  return (
    <div className="flex justify-center items-center gap-8 p-10 bg-[#EBF3FF]">
      <div className="bg-white p-6 rounded-2xl shadow-lg flex flex-col items-center text-center w-64">
        ...
        <button className="mt-4 px-6 py-2 cursor-pointer bg-slate-900 text-white rounded-full flex items-center gap-2">Individual <span className="text-lg">→</span></button>
      </div>
      <div className="bg-white p-6 rounded-2xl shadow-lg flex flex-col items-center text-center w-64">
        <div className="text-sky-500 text-4xl mb-4">
        ...
        <button className="mt-4 px-6 py-2 cursor-pointer bg-slate-900 text-white rounded-full flex items-center gap-2">Team <span className="text-lg">→</span></button>
      </div>
    </div>
  );
};
